...
def Weight_Loss():
    ...
    data = pd.read_csv("C:\\Users\\HP\\Downloads\\food.csv")
    ...
    datafin = pd.read_csv("C:\\Users\\HP\\Downloads\\nutrition_distribution.csv")
...
Button(main_win, text='Weight Loss', font='Helvetica 8 bold', command=Weight_Loss).grid(row=1, column=4, sticky=W,
                                                                                        pady=4)
Button(main_win, text='Weight Gain', font='Helvetica 8 bold', command=Weight_Gain).grid(row=2, column=4, sticky=W,
                                                                                        pady=4)
