...
model = joblib.load("C:\\Users\\HP\\Downloads\\drug-recommender.pkl")


@app.route('/')
def home():
    return render_template("C:\\Users\\HP\\PycharmProjects\\drug recommendation\\Drug_App_Template.html")
...
def predict():
    if request.method == 'POST':
        ...
        prediction_text = 'Predicted Drug is ' + prediction[0]
